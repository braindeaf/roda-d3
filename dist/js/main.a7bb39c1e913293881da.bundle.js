...
/* harmony default export */ var src_selectAll = (function(selector) {
  return typeof selector === "string"
      ...
      : new Selection([array(selector)], selection_root);
});
...
turbolinks_default.a.start();
console.log("hello, world!");

const div = src_selectAll("div#d3");
src_selectAll("p").style("color", "blue");
src_select("body").style("background-color", "black");
src_selectAll("p").style("color", function () {
